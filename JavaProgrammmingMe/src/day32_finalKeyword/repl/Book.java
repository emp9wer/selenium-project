...
public class Book {
    ...
    public void setAuthor(String author) {
        ...
        if(author.isEmpty()){
            ...
            this.author = author.substring(0,1).toUpperCase()+author.substring(1,author.indexOf(" ")).toLowerCase()+" "+
                    author.substring(author.indexOf(" ")+1,author.indexOf(" ")+2).toUpperCase()+author.substring(author.indexOf(" ")+2).toLowerCase();
        }
