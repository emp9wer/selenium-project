...
public class Device {
    ...
    public void setBrand(String brand) {
        if(brand.equalsIgnoreCase("null")||brand.isEmpty()||brand.isBlank()){
            System.err.println("brand can not be null can not be empty or blank");
            System.exit(1);
        }
        this.brand = brand;
    }
    ...
    public void setModel(String model) {
        if(model.equalsIgnoreCase("null")||model.isEmpty()||model.isBlank()){
            System.err.println("model can not be null can not be empty or blank");
            System.exit(1);
        }
        this.model = model;
    }
    ...
    public void turnOn(){
        System.out.println(getClass().getSimpleName()+" "+getBrand()+" "+ getModel()+" is turned on");
    }
    public void  turnOff(){
        System.out.println(getClass().getSimpleName()+" "+getBrand()+" "+ getModel()+" is turned off");
    }
