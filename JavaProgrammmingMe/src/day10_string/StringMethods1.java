...
public class StringMethods1 {
    ...
    String str = "Cydeo";// 0 1 2 3 4 (5 characters)
        //index   01234
      ...
      //char sixthChar = str.charAt(5); // will return error
      //index number can not be negative!
        ...
        System.out.println(lastIndex); // last index number in the String

        System.out.println("_______________display first and last characters of the String___________________");
        ...
        System.out.println("__________________________compare string values if they are equal________________________");
