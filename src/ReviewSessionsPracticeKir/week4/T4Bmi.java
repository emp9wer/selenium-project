package ReviewSessionsPracticeKir.week4;

public class T4Bmi {
    public static void main(String[] args) {
        double mass = 40, height = 1.2;
        ...
        if ((mass >= 40 && mass <= 185) && (height >= 1.2 && height <= 2.5)) {
            ...
            System.out.println("sorry we cannot calculate bmi with these metrics");
...
T4BMI [nested if, multibranch, relational, arithmetic]
    ...
    use these ranges for BMI to print the result
