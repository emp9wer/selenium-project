...
public class GradeLevel {
    ...
    public static void main(String[] args) {
        ...
        if(gradeLevel <= 5){          // false when gradeLevel  >= 6
            result ="Elementary School";
        } else if (gradeLevel <= 8) { //false when gradeLevel >= 9
            result ="Middle School";
        } else if (gradeLevel <= 12) { //false when gradeLevel >= 13
            result = "High School";
        } else if (gradeLevel <= 16) { //false when gradeLevel >= 17;
            result = "College";
        } else {
            result = "Grad School";
        }
