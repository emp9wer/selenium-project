...
public class T2_findElements {
    ...
    public static void main(String[] args) {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10)); //5-10  if app is super slow 30
        ...
        System.out.println("number of the links on the page: "+listOfLinks.size());
        System.out.println("---------------------------------------------------");
